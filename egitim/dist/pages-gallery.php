...
// connect to the database
	...
	// write query for all sayısal dersler
	$sayisal = 'SELECT adi, resim FROM dersler where id in (5,6)';

	// get the result set (set of rows)
	$result = mysqli_query($conn, $sayisal);

	// fetch the resulting rows as an array
	$sayisal = mysqli_fetch_all($result, MYSQLI_ASSOC);

	// free the $result from memory (good practise)
	mysqli_free_result($result);

    // write query for all sayısal dersler
	$sozel = 'SELECT adi, resim FROM dersler where id in (1,2,4)';

	// get the result set (set of rows)
	$result = mysqli_query($conn, $sozel);

	// fetch the resulting rows as an array
	$sozel = mysqli_fetch_all($result, MYSQLI_ASSOC);

	// free the $result from memory (good practise)
	mysqli_free_result($result);

    // write query for all sayısal dersler
	$yabancidil = 'SELECT adi, resim FROM dersler where id in (3)';

	// get the result set (set of rows)
	$result = mysqli_query($conn, $yabancidil);

	// fetch the resulting rows as an array
	$yabancidil = mysqli_fetch_all($result, MYSQLI_ASSOC);
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Gallery | Xoric - Responsive Bootstrap 4 Admin Dashboard</title>
                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">Gallery</h4>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <ul class="col list-inline gallery-categories-filter text-center" id="filter">
                                                    <li class="list-inline-item"><a class="categories active" data-filter="*">Tümü</a></li>
                                                    <li class="list-inline-item"><a class="categories" data-filter=".sozel">Sözel</a></li>
                                                    <li class="list-inline-item"><a class="categories" data-filter=".sayisal">Sayısal</a></li>
                                                    <li class="list-inline-item"><a class="categories" data-filter=".yabancidil">Yabancı Dil</a></li>
                                            ...
                                            <!-- Gallary -->
                                                ...
                                                <div class="row container-grid projects-wrapper">
                                                    <div class="col-xl-3 col-md-4 col-sm-6 sayisal">
                                                        ...
                                                        <a class="gallery-popup" href="<?php echo 'data:image;base64,'.base64_encode($sayi['resim']) ?>" >
                                                            <img class="gallery-demo-img img-fluid mx-auto" width="500" src=" <?php echo 'data:image;base64,'.base64_encode($sayi['resim']) ?>"  />
                                           ...
                                           <?php foreach ($sozel as $soz){ ?>
                                                <div class="row container-grid projects-wrapper">
                                                    <div class="col-xl-3 col-md-4 col-sm-6 sozel">
                                                        <div class="gallery-box mt-4">
                                                            
                                                        <a class="gallery-popup" href="<?php echo 'data:image;base64,'.base64_encode($soz['resim']) ?>" >
                                                            <img class="gallery-demo-img img-fluid mx-auto" width="500" src=" <?php echo 'data:image;base64,'.base64_encode($soz['resim']) ?>"  />
                                                                <div class="gallery-overlay">
                                                                    <div class="overlay-content">
                                                                        <h5 class="overlay-title"><?php echo htmlspecialchars($soz['adi']); ?></h5>
                                           ...
                                           <?php foreach ($yabancidil as $yabanci){ ?>
                                                <div class="row container-grid projects-wrapper">
                                                    <div class="col-xl-3 col-md-4 col-sm-6 yabancidil">
                                                        <div class="gallery-box mt-4">
                                                            
                                                        <a class="gallery-popup" href="<?php echo 'data:image;base64,'.base64_encode($yabanci['resim']) ?>" >
                                                            <img class="gallery-demo-img img-fluid mx-auto" width="500" src="<?php echo 'data:image;base64,'.base64_encode($yabanci['resim']) ?>"  />
                                                                <div class="gallery-overlay">
                                                                    <div class="overlay-content">
                                                                        <h5 class="overlay-title"><?php echo htmlspecialchars($yabanci['adi']); ?></h5>
