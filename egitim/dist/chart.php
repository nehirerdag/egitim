...
$conn = new mysqli('localhost','nehir','zxcv1234','egitim') or die($mysqli->error);

$ogrenci = '';
$genel = '';

$query = "SELECT * FROM analiz";
$result = mysqli_query($conn, $query);
$chart_data = '';
while($row = mysqli_fetch_array($result))
{
 $chart_data .= "{ ogrenci:'".$row["ogrenci"]."', genel:".$row["genel"]."} ";
}
