                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title">Eğitim Setleri</h4>
                                    ...
                                    <div>
                                        ...
                                        <div class="row">
										  ...
										  <?php foreach($dersler as $ders){  ?>
                                            ...
                                            <div id= "hover" class="col-xl-6">
                                                <div class="card">
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col-md-7">
                                                            <div class="card-body"><?php echo '<img src="data:image;base64,'.base64_encode($ders['resim']).'" height="300" width="700">'; ?>	</div>
																
                                                                <h5 class="card-title"> <?php echo htmlspecialchars($ders['adi']); ?></h5><br></br>
																	<p class = "icerik"><i class="fas fa-clock"></i>  Zaman / Performans:</p>
																	<p class = "icerik"><i class="fas fa-list-ul"></i>  Çözülen Soru Sayısı:</p>
																	<p class = "icerik"><i class="fas fa-percentage"></i>  Tamamlanma Oranı:</p>
