...
if(isset($_POST['ASC']))
{
$asc_query = "SELECT * FROM konular ORDER BY ders ASC";

$result = executeQuery($asc_query);
$konular = mysqli_fetch_all($result, MYSQLI_ASSOC);

}	else{
// write query for all dersler
$sql = 'SELECT ders, konu, alt_konu FROM konular';
...
{
$connect = mysqli_connect("localhost", "nehir", "zxcv1234", "egitim");
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
										...
										<form action="tables-datatable.php" method="post">
                                           <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                <tr>
                                                    <td><?php echo htmlspecialchars($konu['ders']); ?></td>
													
                                                    <td><?php echo htmlspecialchars($konu['konu']); ?></td>
													
													<td><?php echo htmlspecialchars($konu['alt_konu']); ?></td>
