...
// connect to the database
	...
	$email = $ad = $soyad = $tarih = $sebep = $sinif = '';
	$errors = array('email' => '', 'ad' => '', 'soyad' => '', 'tarih' => '', 'sebep' => '', 'sinif' => '');
	...
	if(isset($_POST['submit'])){
			...
			$sebep = mysqli_real_escape_string($conn, $_POST['sebep']);
			...
			$sql = "INSERT INTO form(ad,soyad,email,tarih,sebep,sinif) VALUES('$ad','$soyad','$email','$tarih','$sebep','$sinif')";
			echo 'eklendi!';
        ...
        <div id="layout-wrapper">
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <section>
                        <form action="form-elements.php" method="POST">
							<br></br>
                            <h4 class="header-title">Bize Ulaşın</h4>
                                           
    
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Ad</label>
                                        <div class="col-md-10">
                                          <input class="form-control" name="ad" value="<?php echo htmlspecialchars($ad) ?>" id="example-text-input">
                                        </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Soyad</label>
                                        <div class="col-md-10">
                                          <input class="form-control" name="soyad" value="<?php echo htmlspecialchars($soyad) ?>" id="example-text-input">
                                        </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-email-input" class="col-md-2 col-form-label">Email</label>
                                        <div class="col-md-10">
                                          <input class="form-control" name="email"  value="<?php echo htmlspecialchars($email) ?>" id="example-email-input">
                                        </div>
                                </div>
											
								<div class="form-group row">
                                    <label placeholder= "" for="example-date-input" class="col-md-2 col-form-label">Tarih</label>
                                        <div class="col-md-10">
                                          <input class="form-control" name="tarih" type="date" value="<?php echo htmlspecialchars($tarih) ?>" id="example-date-input">
                                        </div>
                                </div>
								
								<div class="form-group row">
                                    <label for="example-date-input" class="col-md-2 col-form-label">Sınıf</label>
                                        <div  class="col-md-10">
                                          
										    <div class="mt-4 mt-sm-0">
                                                        
                                                <div  class="custom-control custom-radio custom-control-inline">
                                                    <input  value="8" type="radio" id="customInlineRadio1" name="sinif" class="custom-control-input" checked>
                                                    <label  class="custom-control-label" for="customInlineRadio1">8</label>
                                                </div>
                                                <div  class="custom-control custom-radio custom-control-inline">
                                                    <input value="12" type="radio" id="customInlineRadio2" name="sinif" class="custom-control-input">
                                                    <label  class="custom-control-label" for="customInlineRadio2">12</label>
                                                </div>
                                            </div>
                                        </div>
                                </div> 
								...
								<div class="form-group row">
                                    <label class="col-md-2 col-form-label">Sebep</label>
                                        <div class="col-md-10">
								...
								<div style="margin-left: 272px; margin-top:50px" class="center">
